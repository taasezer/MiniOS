...
EXTERN scheduler_init_and_start
EXTERN main_idle
...
_start:
    ...
    ; start scheduler (creates tasks and jumps to scheduler)
    call scheduler_init_and_start
...
SECTION .rodata
boot_msg: db "Ultimate Mini OS v4 - COMPLETE: ZIRVE BOOTED!", 0x0A, 0
